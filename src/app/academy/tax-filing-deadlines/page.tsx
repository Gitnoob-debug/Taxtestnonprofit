...
export const metadata: Metadata = {
  title: 'Canadian Tax Filing Deadlines 2024 | Important Dates & Penalties',
  description: 'Complete guide to Canadian tax deadlines. Learn filing due dates for individuals, self-employed, corporations, RRSP deadlines, and penalties for late filing.',
  keywords: 'tax deadline Canada 2024, CRA filing deadline, when are taxes due Canada, late filing penalty CRA, RRSP deadline',
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            Canadian Tax Filing Deadlines 2024
          </h1>
        ...
        <div className="bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-2xl p-6 sm:p-8 mb-10">
          <h2 className="font-bold text-red-900 dark:text-red-100 mb-3">Key 2024 Deadline</h2>
          <p className="text-red-700 dark:text-red-300 text-sm">
            For most Canadians, the 2024 tax return (for 2023 income) is due <strong>April 30, 2024</strong>. Self-employed individuals have until June 15, 2024, but any balance owing is still due April 30.
          </p>
        </div>

        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20 prose-h2:text-2xl prose-h2:sm:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-4 prose-p:text-base prose-p:sm:text-lg prose-p:leading-relaxed prose-li:text-base prose-li:sm:text-lg">

          <h2>Key Tax Deadlines for 2024</h2>
          ...
          <ul>
            <li><strong>For 2023 tax year:</strong> March 1, 2024</li>
          ...
          <h2>Important 2024 Dates Calendar</h2>
          <table className="text-sm">
            <thead>
              <tr>
                <th>Date</th>
            ...
            <tbody>
              ...
              <tr>
                <td>March 1</td>
                <td>RRSP deadline for 2023 tax year</td>
              </tr>
              <tr>
                <td>March 15</td>

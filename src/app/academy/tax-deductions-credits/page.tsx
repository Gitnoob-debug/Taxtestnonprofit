  ...
  return (
    <article className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {/* Intro Box */}
        <div className="bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800 rounded-xl p-6 mb-8">
        ...
        <div className="mt-12 border-t border-slate-200 dark:border-slate-700 pt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link href="/academy/self-employment-taxes" className="p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-700 transition-colors">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-1">Self-Employment Taxes</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">Business deductions for freelancers</p>
            </Link>
            <Link href="/tools/tax-calculator" className="p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-700 transition-colors">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-1">Income Tax Calculator</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">See your tax owing after deductions</p>
            </Link>
          </div>
        </div>
      </div>
